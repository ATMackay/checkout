...
//
//	mockgen -destination ./mock/database_mock.go -package mock github.com/ATMackay/checkout/database Database,HealthChecker,InventoryStore,OrderStore,OutboxStore
//
